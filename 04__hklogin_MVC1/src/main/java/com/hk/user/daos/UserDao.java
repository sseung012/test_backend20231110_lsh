...
//외부에서 메서드를 호출하는 방법
//객체생성해서 객체명.메서드();
//Static으로 선언 -> 클래스명.메서드();
public class UserDao extends DataBase {

	
	private static UserDao userDao;	//생성된 객체를 저장
	//싱글톤 패턴: 객체를 한 번만 생성하자
	private UserDao() {}	//new LoginDao() X : 외부 접근 금지
	
	public static UserDao getUserDao() {	//메서드를 통해 접근 가능하게 만듦
		if(userDao==null) {
