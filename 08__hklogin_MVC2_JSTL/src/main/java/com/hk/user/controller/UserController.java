...
public class UserController extends HttpServlet {
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      if(command.equals("/registForm.user")) { //회원가입폼 이동
         ...
         if(ldto==null||ldto.getId()==null) {
            ...
            if(ldto.getRole().toUpperCase().equals("ADMIN")) {
               ...
               dispatch("managerMain.jsp", request, response);
      ...
      }else if(command.equals("/updateUser.user")) { //나의정보수정
         String id=request.getParameter("id");
         String address=request.getParameter("address");
         String email=request.getParameter("email");
      ...
      }else if(command.equals("/getUserAllList.user")) { //회원전체조회
      ...
      }else if(command.equals("/getUserList.user")) {//회원정보 조회[등급수정}
