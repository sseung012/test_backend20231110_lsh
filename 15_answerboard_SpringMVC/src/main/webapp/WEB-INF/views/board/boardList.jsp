...
<jsp:useBean id="l ut" class="w com.hk.otter.utils.Ut"	/>
<body>
<h1>답변형 게시판</h1>
<div id="container">
	<h2>글 목록 조회</h2>
...
<%--            <a ${(session.pnum==i || param.pnum==i )?"class='active'" :""} href="boardList.do?pnum=${i}"> ${i}</a>&nbsp;&nbsp; --%>
<%--            </c:forEach> --%>
<%--            <a href="boardList.do?pnum=${pMap.nextPageNum}">▶</a> --%>
         ...
         <tr>
            <td colspan="10">
               <button class="btn badge bg-dark-subtle border border-dark-subtle text-dark-emphasis rounded-pill" type="button"  onclick="location.href='insertForm.do'">추가</button>
               <button class="btn badge bg-dark-subtle border border-dark-subtle text-dark-emphasis rounded-pill" type="submit">삭제</button>
            </td>
         </tr>
      </table>
      </form>
