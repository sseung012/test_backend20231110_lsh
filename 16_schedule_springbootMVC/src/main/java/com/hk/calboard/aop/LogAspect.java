...
//   public void test() {}
	...
	//execution(): 메서드단위로 설정 - com.hk.calboard.controller.*Board(..)
	//within() : 객체 단위 설정 - com.hk.calboard.controller.CalController.*
	@Pointcut(value = "within(com.hk.calboard.controller.*)")
