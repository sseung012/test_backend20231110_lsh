			...
			<c:forEach var="mlist" items="${mlist}">
               <div class="col mb-5">
                   <div class="card h-100">
                        <!-- Product image-->
                        <img class="card-img-top" src="/upload/${mlist.img}" alt="..." width="220" height="190"/>
                        <!-- Product details-->
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                           <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="/product/productDetail/17"}>자세히볼까나?</a></div>
                              </div>
                        </div>
                      </div>
			</c:forEach>
