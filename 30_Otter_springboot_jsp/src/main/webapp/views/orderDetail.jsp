...
<%-- 										<input type="text" name="role" value="${odto.select_amount}" readonly="readonly" class="form-control1"/> --%>
								...
								<tr>
									<th>주소</th>
									<td>
										<input type="text" name="address1" value="${odto.address1}" readonly="readonly" class="form-control1"/>
										<input type="text" name="address2" value="${odto.address2}" readonly="readonly" class="form-control1"/>
										<input type="text" name="address3" value="${odto.address3}" readonly="readonly" class="form-control1"/>
									</td>
								</tr>
								<tr>
									<th>전화번호</th>
