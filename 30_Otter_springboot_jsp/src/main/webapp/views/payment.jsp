...
<!--                             <input type="hidden" name="seq"/> -->
                        ...
                        <div class="payment">
                            <label for="maker" class="form-label">주문자</label>
						...
						<div class="payment">
							...
							<div class="address_input_1_wrap">
								<div class="address_input_1_box">
									<input class="address_input_1" name="addr1" readonly="readonly">
								</div>
							...
							<div class="address_input_2_wrap">
								<div class="address_input_2_box">
									<input class="address_input_2" name="addr2" readonly="readonly">
								</div>
							</div>
